            ...
            <div className="grid grid-cols-2 gap-1 border-t border-gray-100 p-1.5">
              {onManage && (
                <button
                  ...
                  className="flex h-8 min-w-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-md px-2 text-xs text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                >
                  <Settings2 size={14} />
                  管理知识库
                </button>
