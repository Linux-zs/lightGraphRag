    ...
    return {
        ...
        "bindings": {
            ...
            "embedding": {
                ...
                "embed_max_chars": int(sf.get("embed_max_chars", 480)),
                "embed_max_tokens": int(sf.get("embed_max_tokens", 480)),
            },
            "rerank": {
                "profile_id": DEFAULT_PROFILE_ID,
...
def get_runtime_model_config(config: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "embedding": {
            ...
            "embed_max_chars": int(embedding.get("embed_max_chars") or sf.get("embed_max_chars", 480)),
